...
if($num == 1){
    ...
    mysqli_query($conn, $addtoken);
        ...
        $mail->Password = 'dlwy uejl ryaj qigd'; // password
        $mail->setFrom('hhsresources@gmail.com', 'HHS Resources'); // From email and name
        ...
        to rest your password: http://hhsresources.000webhostapp.com/reset.php?token=$token"); //$mail->msgHTML(file_get_contents('contents.html'), __DIR__); //Read an HTML message body from an external file, convert referenced images to embedded,
